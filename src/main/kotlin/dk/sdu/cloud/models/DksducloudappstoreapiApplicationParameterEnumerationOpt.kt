 ...
 * @param type
 */
data class DksducloudappstoreapiApplicationParameterEnumerationOpt(
    ...
    @field:JsonProperty("type") val type: DksducloudappstoreapiApplicationParameterEnumerationOpt.Type? = null
) {
