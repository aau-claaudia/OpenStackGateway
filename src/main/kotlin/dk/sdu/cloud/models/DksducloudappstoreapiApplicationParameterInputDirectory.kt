 ...
 * @param type
 */
data class DksducloudappstoreapiApplicationParameterInputDirectory(
    ...
    @field:JsonProperty("type") val type: DksducloudappstoreapiApplicationParameterInputDirectory.Type? = null
) {
