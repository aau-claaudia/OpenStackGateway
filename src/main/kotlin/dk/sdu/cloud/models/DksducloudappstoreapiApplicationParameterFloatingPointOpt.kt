 ...
 * @param type
 */
data class DksducloudappstoreapiApplicationParameterFloatingPointOpt(
    ...
    @field:JsonProperty("type") val type: DksducloudappstoreapiApplicationParameterFloatingPointOpt.Type? = null
) {
