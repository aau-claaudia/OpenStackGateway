 ...
 * @param type
 */
data class DksducloudappstoreapiVariableInvocationParameterOpt(
    ...
    @field:JsonProperty("type") val type: DksducloudappstoreapiVariableInvocationParameterOpt.Type? = null
) {
