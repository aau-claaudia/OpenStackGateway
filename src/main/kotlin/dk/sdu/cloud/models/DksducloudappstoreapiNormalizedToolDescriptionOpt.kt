 ...
 * @param license
 */
data class DksducloudappstoreapiNormalizedToolDescriptionOpt(
    ...
    @field:JsonProperty("backend") val backend: DksducloudappstoreapiNormalizedToolDescriptionOpt.Backend? = null,
