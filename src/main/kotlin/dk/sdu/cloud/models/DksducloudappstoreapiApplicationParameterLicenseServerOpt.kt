 ...
 * @param type
 */
data class DksducloudappstoreapiApplicationParameterLicenseServerOpt(
    ...
    @field:JsonProperty("type") val type: DksducloudappstoreapiApplicationParameterLicenseServerOpt.Type? = null
) {
