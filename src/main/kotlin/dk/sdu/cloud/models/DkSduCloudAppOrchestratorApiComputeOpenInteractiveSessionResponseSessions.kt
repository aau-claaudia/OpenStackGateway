...
interface DkSduCloudAppOrchestratorApiComputeOpenInteractiveSessionResponseSessions {

    val jobId: kotlin.String?

    val rank: kotlin.Int?

    val type: DkSduCloudAppOrchestratorApiComputeOpenInteractiveSessionResponseSessions.Type?
