 ...
 * @param type
 */
data class DksducloudappstoreapiApplicationParameterIntegerOpt(
    ...
    @field:JsonProperty("type") val type: DksducloudappstoreapiApplicationParameterIntegerOpt.Type? = null
) {
