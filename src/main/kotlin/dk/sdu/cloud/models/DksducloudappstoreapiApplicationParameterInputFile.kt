 ...
 * @param type
 */
data class DksducloudappstoreapiApplicationParameterInputFile(
    ...
    @field:JsonProperty("type") val type: DksducloudappstoreapiApplicationParameterInputFile.Type? = null
) {
